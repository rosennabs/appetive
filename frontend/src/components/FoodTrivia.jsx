...
export default function FoodTrivia() {
  ...
  return (
    ...
    <div className="flex flex-col items-center font-bold text-amber-700 text-center relative">
      ...
      <button onClick={()=> fetchRandomTrivia()} type="button" className="bg-green-600 hover:bg-green-800 text-white font-bold py-5 px-16 -mt-8 rounded-md text-3xl">START</button>
